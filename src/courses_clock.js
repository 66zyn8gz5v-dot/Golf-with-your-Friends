...
const CLOCK_COURSES = [
  ...
  {
    name: 'Maschinenprobe', par: 4, theme: 'escapement', maxStrokes: 14,
    intro: 'Eine Probe für die Maschinen zwischen den Ebenen. Unten stehen drei Aufstiege nebeneinander: Die Turbine hebt sofort, der Kettenzug nur, wenn gerade ein Haken unten ist, und die Zahnstange nimmt mit, wer beim Losfahren auf der Schaufel steht. Oben liegt die Luke im Weg – zu ist sie Boden, offen ein Loch. Ganz nach oben führt nur das Kupferrohr. Gestürzt wird hier nie mit Strafschlag, nur mit Zeitverlust.',
    map: [
      '..............................',
      '..............................',
      '..............................',
    ...
    obstacles: [
      { type: 'turbine', x: 8.5, y: 6.5, w: 1.4, h: 1.4 },
      { type: 'kettenzug', x: 13.5, y: 6.5, angle: 0 },
      { type: 'zahnstange', x: 18.5, y: 6.5, angle: 0 },
      { type: 'luke', x: 16.5, y: 6.5, w: 1.6, h: 1.6, ebene: 1 },
      { type: 'copperpipe', pair: 'A', angle: 0, ebene: 1, ziel: 2 },
    ],
    decor: [
      { t: 'lantern', x: 5.5, y: 2.5, s: 1 },
      { t: 'lantern', x: 22.5, y: 10.5, s: 1 },
      { t: 'gearFlat', x: 12, y: 11, s: 1.4 },
    ],
    autoDecor: { density: 0.1, seed: 77 },
  },
];
