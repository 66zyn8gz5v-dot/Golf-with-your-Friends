...
const CLOCK_COURSES = [
  ...
  {
    name: 'Zeigerscheibe', par: 3, theme: 'clocktown', maxStrokes: 14,
    intro: 'Testbahn für den Zeigerarm. Er geht seine Runde in zwölf Sekunden und schiebt alles vor sich her, was auf der Scheibe liegt. Abschlag und Loch liegen knapp außerhalb seiner Reichweite – dazwischen muss man hindurch.',
    map: [
      '..........................',
      '...........####...........',
      '.........########.........',
    ...
    obstacles: [
      { type: 'sweephand', x: 13, y: 7.5, r: 4.5, thick: 0.24, phase: 0 },
    ],
    decor: [
      { t: 'clock', x: 13, y: 0.6, s: 2.2 },
      { t: 'lantern', x: 4.5, y: 3.5 }, { t: 'lantern', x: 21.5, y: 11.5 },
    ],
    autoDecor: { density: 0.1, seed: 5 },
  },
  {
    name: 'Zifferblatt', par: 4, theme: 'escapement', maxStrokes: 18,
    intro: 'Testbahn für das Zifferblatt. Das Loch bleibt zehn Sekunden auf einer Stundenmarke und springt dann eine weiter, immer im Uhrzeigersinn. Der schrumpfende Ring zeigt, wo es als Nächstes ist und wie lange noch – schlag so, dass der Ball ankommt, wenn das Loch da ist.',
    map: [
      '..........................',
      '..........######..........',
      '.........####H###.........',
    ...
    obstacles: [
      { type: 'dial', x: 13, y: 7.5, r: 5, marken: 12, phase: 0 },
    ],
    decor: [
      { t: 'lantern', x: 4.5, y: 7.5 }, { t: 'lantern', x: 21.5, y: 7.5 },
      { t: 'gearFlat', x: 13, y: 0.8, s: 1.6, speed: 0.3, seed: 0.5 },
    ],
    autoDecor: { density: 0.08, seed: 33 },
  },
];
