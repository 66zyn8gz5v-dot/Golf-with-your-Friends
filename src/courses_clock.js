...
const CLOCK_COURSES = [
  ...
  },
  {
    ...
    obstacles: [
      { type: 'turbine', x: 12.5, y: 4.5, w: 1.4, h: 1.4 },
    ],
    decor: [
      { t: 'lantern', x: 5.5, y: 1.5, s: 1 },
      { t: 'lantern', x: 16.5, y: 7.5, s: 1 },
      { t: 'gearFlat', x: 9, y: 7.6, s: 1.4 },
    ],
