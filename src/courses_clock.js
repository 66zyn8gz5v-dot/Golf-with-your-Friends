...
const CLOCK_COURSES = [
  {
    ...
    obstacles: [
      { type: 'pendulum', x: 17.5, y: 2.5, len: 4, amp: 60, ruhe: 90, phase: 0, w: 1.2, h: 1.2 },
    ],
    decor: [
  ...
  },
  {
    ...
    obstacles: [
      { type: 'pendulum', x: 13.5, y: 2.5, len: 4, amp: 60, ruhe: 90, phase: 0, w: 1.2, h: 1.2 },
      { type: 'pendulum', x: 25.5, y: 2.5, len: 4, amp: 60, ruhe: 90, phase: 0.5, w: 1.2, h: 1.2 },
    ],
    decor: [
