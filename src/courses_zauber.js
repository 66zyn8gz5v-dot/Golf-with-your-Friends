...
const ZAUBER_GARTEN = [
  ...
  {
    name: 'Der Blätterwirbel', par: 4, theme: 'lehrlingsgarten',
    intro: 'Zwei Beete stehen versetzt, dazwischen geht es im Zickzack. Das Seelenlicht zieht an allem, was an ihm vorbeirollt – ausgerechnet in der ersten Kehre, wo man ohnehin schon aufpassen muß. Der Laubwirbel dahinter fängt den Ball und wirft ihn immer nach unten aus; wer ihn trifft, spart sich die halbe Bahn.',
    map: [
      '..............................',
      '..............................',
      '..............................',
    ...
    obstacles: [
      ...
      { type: 'magnet', x: 8.5, y: 9.5, r: 2.6, strength: 5.0, slow: 0, style: 'soul' },
      { type: 'turntable', x: 15.5, y: 5.5, r: 1.8, speed: 1.8, exit: 90, eject: 4.5 },
      { type: 'bumper', x: 22.5, y: 5.5, r: 0.55, style: 'mushroom', kick: 7.5 },
    ],
...
const ZAUBER_WARTE = [
  ...
  },
  {
    ...
    obstacles: [
      { type: 'ranke', x: 9, y: 6, w: 4, h: 3, dauer: 4.5, r: 0.6, bluete: { x: 6.5, y: 7.5 } },
