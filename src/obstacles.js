...
function createObstacles(defs) {
  ...
  for (const d of defs) {
    switch (d.type) {
      ...
      case 'wracktor': out.push(new Wracktor(d)); break;
      case 'abflussrohr': out.push(new Abflussrohr(d)); break;
      // Schneeberg
      ...
      case 'riesenbluete': out.push(new Riesenbluete(d)); break;
      case 'armillar': out.push(new Armillarsphaere(d)); break;
      case 'bannwaechter': out.push(new Bannwaechter(d)); break;
