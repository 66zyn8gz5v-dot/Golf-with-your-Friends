...
| 3 | Fallbeilgasse | 5 | zwei Fallbeile im Takt, Knochenrampe über eine Schattenfeuergrube, drittes Beil, Kehre, letztes Fallbeil vor dem Loch |
...
| 6 | Knochenbrücke | 5 | Steg ohne Geländer über den Feuerstrom oder der Basilisk am Ufer, der den Ball über das Feuer auf die Insel spuckt; Knochenstacheln, riesiges Fallbeil quer über die Insel, schmaler zweiter Steg |
| 7 | Schattenschloss | 8 | zweiteilige Bahn: Vorhof, Zugbrücke (Rampe) über den Feuergraben, Torhaus mit Fallgatter, Burghof mit Feuergraben, Rampe, drei verfluchten Rittern, Geist und Augenbumper; hinter dem schwarzen Tor der Thronsaal: Kerkergang mit Sense und Fallbeil, der Basilisk spuckt den Ball auf die Empore zum Loch |
| 8 | Turm des Auges | 5 | großer Platz mit dem Augenturm in der Mitte; Gruftblöcke als Deckung, Feuergraben mit Knochenrampe vor dem Loch, Fledermaus – nie im Licht liegen bleiben |
