...
const DYN = new Set(['mover', 'wave', 'sharkjump', 'spikes', 'rotor', 'gate', 'ferry', 'windmill', 'cannon', 'turntable', 'cauldron', 'lightning', 'trapdoor', 'gearlift', 'piston', 'hand', 'gearfield', 'pendulum', 'springwork', 'escapement', 'sweephand', 'dial', 'wanderloch', 'handclock', 'turbine', 'luke']);
