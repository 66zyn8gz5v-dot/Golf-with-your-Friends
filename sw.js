...
const APP_FILES = [
  ...
  './src/version.js', './src/text.js', './src/themes.js', './src/courses.js', './src/courses_sea.js', './src/courses_jungle.js', './src/courses_storm.js', './src/courses_shadow.js', './src/courses_colosseum.js', './src/courses_clock.js', './src/courses_pro.js', './src/level.js', './src/obstacles.js', './src/obstacles_legend.js',
  './src/physics.js', './src/render.js', './src/render_legend.js', './src/icons.js', './src/hats.js', './src/net.js', './src/best.js', './src/turnier.js', './src/share.js', './src/sfx.js', './src/music.js', './src/worldmap.js', './src/title.js', './src/editor.js', './src/main.js',
